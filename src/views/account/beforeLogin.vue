<template>
    ...
    <v-col cols="12" align="center" justify="center" style="margin-top:200px">
        <appbar :appBarHeight="appBarHeight" class="black" :arrow="false"></appbar>          
        <!-- <v-row style="width:65%; height:85%; margin-top:100px;">
            <v-img src="@/assets/beforeLoginLogo.png">
            </v-img>
        </v-row> -->
        <!-- <v-btn :disabled="disabled"  style="width:100%; margin-top:83px; margin-bottom:6px; padding:0px 0px 0px 0px; height:48px;" color="#3B5998" light large @click="clickBtn">
            <v-row align="center" justify="center" style="margin:0px;">
                <v-col align="center" justify="center" cols="" style="padding:0px; max-width:18%">
                    <font-awesome-icon style="color:white; width:26px; height:26px;" :icon="{ prefix: 'fab', iconName: 'facebook' }"/>
                </v-col>
                <v-col align="center" justify="center" cols="" style="color:white; font-weight:500; font-size:15px; padding:0px; max-width:70%">
                    페이스북으로 로그인
                </v-col>
                <v-col align="center" justify="center" cols="" style="padding:0px; max-width:12%">
                </v-col>
            </v-row>
        </v-btn> -->
        <!-- <v-btn :disabled="disabled" class="fa-google" outlined style="margin-bottom:6px; width:100%; padding:0px; height:48px;" large @click="clickBtn1">
            <v-row align="center" justify="center" style="margin:0px;">
                ...
                <v-col align="center" justify="center" cols="" style="color:white; font-weight:500; font-size:15px; padding:0px; max-width:68%">
                    구글로 로그인
                </v-col>
